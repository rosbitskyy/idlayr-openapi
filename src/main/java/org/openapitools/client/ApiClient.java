...
public class ApiClient {
    ...
    private String basePath = "https://eu.api.idlayr.com/v2/passkeys";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://eu.api.idlayr.com/v2/passkeys",
      "No description provided",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://us.api.idlayr.com/v2/passkeys",
      "No description provided",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://eu.api.idlayr.com/v2/passkeys
